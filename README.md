...
I build web interfaces, data dashboards, and practical machine learning applications. My work combines personal projects with collaborative software development at **SAIT**.

- 📍 Based in **Calgary, Alberta, Canada**
- 💻 Focused on **React, Python, cloud integration, and useful AI applications**
- 🌱 Interested in **junior software, frontend, and entry-level AI/data opportunities**

## Languages & tools

**Frontend** · `React` `Next.js` `TypeScript` `JavaScript` `HTML` `CSS`  
**AI & data** · `Python` `Pandas` `scikit-learn` `Streamlit` `SQL`  
**Cloud & collaboration** · `Azure` `Firebase` `REST APIs` `WebSockets` `Git`
...
*CareerQuest and Retrofit are public contribution showcases; their team source repositories remain private. Team projects credit my individual role, with original authorship preserved.*

---

**Currently developing:** stronger testing, cloud deployment, and model-evaluation skills.
